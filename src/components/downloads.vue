                        ...
                        <div class="os">
                            <label>
                                ...
                                <input
                                    ...
                                    type="checkbox"
                                    v-model="serverGeneratorForm.isLinux"
                                    name="os"
                                />
                                <!-- if checked – linux! !-->
...
export default {
    ...
    methods: {
        ...
        bundleServer: function() {
            ...
            files.push({
                url:
                    `https://cdn.altv.mp/server/${branch}/${target}/altv-server` +
            ...
            if (this.serverGeneratorForm.includeNodeJS) {
                files.push({
                    url:
                        `https://cdn.altv.mp/node-module/${branch}/${target}/modules/` +
                ...
                files.push({
                    url:
                        `https://cdn.altv.mp/node-module/${branch}/${target}/` +
            ...
            if (this.serverGeneratorForm.includeJS) {
                files.push({
                    ...
                    path:
                        'modules/js-module/' + (!this.serverGeneratorForm.isLinux ? 'js-module.dll' : 'libjs-module.so')
                });
            ...
            if (this.serverGeneratorForm.includeCsharp) {
                files.push({
                    url:
                        `https://cdn.altv.mp/coreclr-module/${branch}/${target}/modules/` +
                        (!this.serverGeneratorForm.isLinux ? 'csharp-module.dll' : 'libcsharp-module.so'),
